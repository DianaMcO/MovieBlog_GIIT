...
<body>
    ...
    <div class="container container-body" style="border-style: solid">
        ...
        <p>If you’d like to be notified of new blogs, you can subscribe on our <a href = "index.php">homepage.</a></p></br>
        <p>Or if you want to post comments and to enter our monthly competitions, please do <a href="signup.php">sign up.</a></p></br>
